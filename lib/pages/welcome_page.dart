        ...
        itemBuilder: (_, index){
          return Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(    // To insert home-page images
                image: AssetImage(
                  "img/"+images[index]
                ),
                fit: BoxFit.cover
              ...
              child: Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      AppLargeText(text: "TRIPS", size: 35, color: Colors.amberAccent,),
                      AppLargeText(text: "Dream Mountains", size: 25,),
                      const SizedBox(height: 20,),
                      SizedBox(     // Sizedbox was Container
                        width: 200,
                        child: AppText(
                      ...
                      GestureDetector(
                        ...
                        child: SizedBox(    // Sizedbox was Container
                          width: 200,
                    ...
                    children: List.generate(3, (indexDots){
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: index == indexDots? AppColors.mainColor : Colors.grey,
                        ),
                      );
                    }),
                  )
